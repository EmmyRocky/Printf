...
{    
register short i, j;    
char rot13[] = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ";    char ROT13[] = "nopqrstuvwxyzabcdefghijklmNOPQRSTUVWXYZABCDEFGHIJKLM";    
...
{            
for (i = 0; i <= 52; i++)                
if (s[j] == rot13[i])                    _putchar(ROT13[i]);        
}    
}    
return (j);
}
